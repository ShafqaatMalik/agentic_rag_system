...
from app.agents.nodes import rewrite_query_node, should_rewrite_or_generate
...
class TestRewriteNodeBehavior:
    ...
    def test_rewrite_increments_iteration(self, mock_rewrite):
        ...
        mock_rewrite.return_value = RewrittenQuery(
            rewritten_query="Improved query", strategy="Expanded with synonyms"
        )
    ...
    def test_rewrite_tracks_history(self, mock_rewrite):
        ...
        mock_rewrite.return_value = RewrittenQuery(
            rewritten_query="Third attempt", strategy="Simplified"
        )
    ...
    def test_rewrite_passes_history_to_chain(self, mock_rewrite):
        ...
        mock_rewrite.return_value = RewrittenQuery(
            rewritten_query="New query", strategy="Different approach"
        )
